        ...
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="accounting-dashboard.html" class="submenu-link">Dashboard</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="accounting-create-transaction.html" class="submenu-link">Create Transaction</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="accounting-history.html" class="submenu-link">History</a>
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="inventory-dashboard.html" class="submenu-link">Dashboard</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="inventory-item-list.html" class="submenu-link">Item List</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="inventory-category-list.html" class="submenu-link">Category List</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="inventory-history.html" class="submenu-link">History</a>
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  has-sub">
                        <a href="#" class="submenu-link">ICON+</a>
                        
                        <ul class="submenu submenu-level-2 ">

                            
                            <li class="submenu-item ">
                                <a href="projects-icon-pa.html" class="submenu-link">PA</a>
                            </li>
                            
                            <li class="submenu-item ">
                                <a href="projects-icon-har.html" class="submenu-link">HAR</a>
                            </li>
                    ...
                    <li class="submenu-item  ">
                        <a href="projects-others.html" class="submenu-link">Others</a>
...
<div class="page-content"> 
    <section class="row">		
        <div class="col-12 col-lg-8">
			<div class="row">
				<div class="col-12">
					<div class="card mainmenu-profilebox-mobile">
						<div class="card-body py-4 px-4">
							<div class="d-flex">
								<div class="col avatar avatar-xl">
									<img src="./assets/compiled/jpg/5.jpg" alt="Face 5">
								</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="divider divider-left">
								<div class="divider-text"><h6 class="mb-0">Accounting</h6></div>
							</div>
							<div class="row align-items-center applications-button-group">
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-cash-stack me-2"></i>
								...
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-cash-coin me-2"></i>
											<p class="mb-0">Create Transaction</p>
										</div>
									</a>
								</div>
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-card-list me-2"></i>
							...
							<div class="divider divider-left">
								<div class="divider-text"><h6 class="mb-0">Inventory</h6></div>
							</div>
							<div class="row align-items-center applications-button-group">
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-archive me-2"></i>
											<p class="mb-0">Dashboard</p>
										</div>
									</a>
								</div>
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-box-seam me-2"></i>
								...
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-tags me-2"></i>
							...
							<div class="divider divider-left">
								<div class="divider-text"><h6 class="mb-0">Projects</h6></div>
							</div>
							<div class="row align-items-center applications-button-group">
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-lightning me-2"></i>
											<p class="mb-0">Icon - PA</p>
										</div>
									</a>
								</div>
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-tools me-2"></i>
											<p class="mb-0">Icon - HAR</p>
										</div>
									</a>
								</div>
								<div class="col-12 col-lg-4">
									<a href="#" class="applications-button-wrapper">
										<div class="d-flex align-items-center px-4 py-2 applications-button">
											<i class="bi bi-middle bi-filter-left me-2"></i>
        ...
        <div class="col-12 col-lg-4">
            <div class="card mainmenu-profilebox-desktop">
                <div class="card-body py-4 px-4">
                    <div class="d-flex">
                        <div class="col avatar avatar-xl">
                            <img src="./assets/compiled/jpg/5.jpg" alt="Face 5">
    ...
    <div class="footer clearfix mb-0 text-muted">
        ...
        <div class="float-end">
            <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                by <a href="https://saugi.me">Anita</a></p>
        </div>
    </div>
</footer>
        </div>
